def CalculateLeafNumber(LeafNumber, Phyllochron, HasFlagLeafLiguleAppeared,SwitchMaize,  DeltaTT, Leaf_tip_emerg, atip,  Nlim,
                                    k_bl, cumulTTPhenoMaizeAtEmergence,cumulTT, phase):
